class Game{
    ...
    start(){
        ...
        this.addSprites(obsG2, obsImg2, obstacles2.length, 0.5, obstacles2);
    }
    ...
    gameOver(){
        ...
        swal({
            title:"Foi de Vasco",
            text:"Seu carro foi de Vasco",
            imageUrl:"https://logodownload.org/wp-content/uploads/2016/09/vasco-logo.png",
            imageSize:"300x300",
            confirmButtonText:"Me deixa chorar em paz"
        })
    ...
    showRank(){
        ...
        swal({
            //titulo
            title:"BOA, "+player.rank+" º LUGAR! Manda seguirem o líder." ,
            //texto
            text:"Você não foi de Vasco!",
            //o endereço da imagem
            imageUrl:"https://media.tenor.com/nar1pvnuql8AAAAC/cavalinho-botafogo.gif",
            //o tamanho dela
            imageSize:'300x300',
            //texto do botãozinho
